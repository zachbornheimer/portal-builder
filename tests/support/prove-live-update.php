...
echo 'same_ignored=' . ( null === Portal_Update::offer_from_release( $latest, PB_VERSION ) ? 'yes' : 'no' ) . "\n";
$loc = Portal_Update::release_from_location( 'https://github.com/zachbornheimer/portal-builder/releases/tag/v0.2.0' );
echo 'redirect_offer=' . ( is_array( Portal_Update::offer_from_release( $loc, PB_VERSION ) ) ? Portal_Update::offer_from_release( $loc, PB_VERSION )['version'] : 'none' ) . "\n";
