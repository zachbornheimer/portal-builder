...
$out = array(
	...
	'checks' => array(
		...
		'file_open_idle'     => false !== strpos( $html, 'Open to confirm' ),
		'file_open_opened'   => false !== strpos( $html, 'data-label-opened' ),
		'file_remove'        => false !== strpos( $html, 'Remove upload' ),
		'no_file_confirm_cb' => false === strpos( $html, 'dg-file-confirm-input' ),
		'file_original'      => false !== strpos( $html, 'data-dg-file-original' ),
		'file_progress'      => false !== strpos( $html, 'data-dg-file-progress' ),
		'file_status'        => false !== strpos( $html, 'data-dg-file-status' ),
		'file_staged_input'  => false !== strpos( $html, 'data-dg-file-staged' ),
		'score_staged_name'  => false !== strpos( $html, 'name="sub_score_staged"' ),
	),
);
